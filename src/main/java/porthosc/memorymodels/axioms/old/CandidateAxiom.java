...
public class CandidateAxiom extends Acyclic {
    ...
    public Consistent[] pos=new Consistent[old.aramis.Aramis.posPrograms.size()];
    public Consistent[] neg=new Consistent[old.aramis.Aramis.negPrograms.size()];
    ...
    public int position;
    public CandidateAxiom[] next=new CandidateAxiom[old.aramis.Aramis.negPrograms.size()];
