...
class CminToYtreeTransformerInterior {

    YVariableRef visitVariableName(CminParser.VariableNameContext ctx) {
        if (ctx == null) {
            return null;
        }
        ...
        return new YVariableRef(identifier);
    }

    YConstant visitConstant(CminParser.ConstantContext ctx) {
        if (ctx == null) {
            return null;
        }
    ...
    YConstant tryParseInternalStringConstant(TerminalNode stringConstant, ParserRuleContext ctx) {
    ...
    YEntity visitVariableDeclarationStatement(CminParser.VariableDeclarationStatementContext ctx) {
        ...
        YBlockStatement declaratorList =
                (YBlockStatement) visitVariableInitialisationList(ctx.variableInitialisationList());

        InternalSequenceStatementBuilder builder = new InternalSequenceStatementBuilder();
        for (YStatement statement : declaratorList.statements) {
            assignStatement = ()
    ...
    YEntity visitTypeDeclarator(CminParser.TypeDeclaratorContext ctx) {
        ...
        YEntity primitiveTypeDeclarator = visitPrimitiveTypeDeclarator(ctx.primitiveTypeDeclarator());
