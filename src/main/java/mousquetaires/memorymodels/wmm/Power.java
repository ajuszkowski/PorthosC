...
public class Power {
    ...
    public static BoolExpr encode(XProgram program, Context ctx) {
        ...
        enc = ctx.mkAnd(enc, Encodings.satUnion("prop", "(WW&prop-base)", "((((com)*;(prop-base)*);sync);(hb-power)*)",
                                                events, ctx));
    ...
    private static BoolExpr satPowerPPO(Set<? extends XEvent> events, Context ctx) {
...
//                            Utils.edge("cc;cc", e1, e2, ctx))));
                    ...
                    enc = ctx.mkAnd(enc, ctx.mkEq(Utils.edge("ii", e1, e2, ctx), ctx.mkOr(
                            ...
                            ctx.mkAnd(Utils.edge("ic;ci", e1, e2, ctx), ctx.mkGt(Utils.intCount("ii", e1, e2, ctx),
                                                                                 Utils.intCount("ic;ci", e1, e2, ctx))),
                            ctx.mkAnd(Utils.edge("ii;ii", e1, e2, ctx), ctx.mkGt(Utils.intCount("ii", e1, e2, ctx),
                                                                                 Utils.intCount("ii;ii", e1, e2,
                                                                                                ctx))))));

                    enc = ctx.mkAnd(enc, ctx.mkEq(Utils.edge("ic", e1, e2, ctx), ctx.mkOr(
                            ...
                            ctx.mkAnd(Utils.edge("ic;cc", e1, e2, ctx), ctx.mkGt(Utils.intCount("ic", e1, e2, ctx),
                                                                                 Utils.intCount("ic;cc", e1, e2, ctx))),
                            ctx.mkAnd(Utils.edge("ii;ic", e1, e2, ctx), ctx.mkGt(Utils.intCount("ic", e1, e2, ctx),
                                                                                 Utils.intCount("ii;ic", e1, e2,
                                                                                                ctx))))));

                    enc = ctx.mkAnd(enc, ctx.mkEq(Utils.edge("ci", e1, e2, ctx), ctx.mkOr(
                            ctx.mkAnd(Utils.edge("ci0", e1, e2, ctx),
                                      ctx.mkGt(Utils.intCount("ci", e1, e2, ctx), Utils.intCount("ci0", e1, e2, ctx))),
                            ctx.mkAnd(Utils.edge("ci;ii", e1, e2, ctx), ctx.mkGt(Utils.intCount("ci", e1, e2, ctx),
                                                                                 Utils.intCount("ci;ii", e1, e2, ctx))),
                            ctx.mkAnd(Utils.edge("cc;ci", e1, e2, ctx), ctx.mkGt(Utils.intCount("ci", e1, e2, ctx),
                                                                                 Utils.intCount("cc;ci", e1, e2,
                                                                                                ctx))))));

                    enc = ctx.mkAnd(enc, ctx.mkEq(Utils.edge("cc", e1, e2, ctx), ctx.mkOr(
                            ...
                            ctx.mkAnd(Utils.edge("ci;ic", e1, e2, ctx), ctx.mkGt(Utils.intCount("cc", e1, e2, ctx),
                                                                                 Utils.intCount("ci;ic", e1, e2, ctx))),
                            ctx.mkAnd(Utils.edge("cc;cc", e1, e2, ctx), ctx.mkGt(Utils.intCount("cc", e1, e2, ctx),
                                                                                 Utils.intCount("cc;cc", e1, e2,
                                                                                                ctx))))));
                }
            }
        }
