...
public class ZRelInterSect extends ZBinaryRelation {

    public ZRelInterSect(ZRelation r1, ZRelation r2, String name) {
        super(r1, r2, name, String.format("(%s&%s)", r1, r2));

    }

    public ZRelInterSect(ZRelation r1, ZRelation r2) {
